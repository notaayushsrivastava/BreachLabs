...
let express, cors, apiRoutes, authRoutes;
...
try {
  ...
  // If express is not installed, boot the pure-Node standard library server
  const { startStandaloneServer } = require('./helpers/standalone_server');
  const PORT = config.PORT;
  if (require.main === module) {
    startStandaloneServer(PORT, '127.0.0.1');
  }
